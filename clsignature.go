...
func signMessageBlockAndCommitment(storage common.PrimeStorage, sk *PrivateKey, pk *PublicKey, U *big.Int, ms []*big.Int) (
	*CLSignature, error) {
...
func SignMessageBlock(storage common.PrimeStorage, sk *PrivateKey, pk *PublicKey, ms []*big.Int) (*CLSignature, error) {
